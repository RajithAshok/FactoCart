...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/productlist',
          asyncParams: {
            'refcat': getDoc(['categories'], CategoriesRecord.fromSnapshot),
          },
          builder: (context, params) => ProductlistWidget(
            catref: params.getParam(
                'catref', ParamType.DocumentReference, false, ['categories']),
            refcat: params.getParam('refcat', ParamType.Document),
          ),
        ),
        FFRoute(
          name: 'editProfile',
        ...
        FFRoute(
          ...
          builder: (context, params) => ProductviewWidget(
            proref: params.getParam(
                'proref', ParamType.DocumentReference, false, ['product']),
          ),
        ),
        FFRoute(
          name: 'checkout',
        ...
        FFRoute(
          name: 'vendorHomepage',
          path: '/vendorHomepage',
          builder: (context, params) => VendorHomepageWidget(),
        ),
        FFRoute(
          name: 'homepage',
          path: '/homepage',
        ...
        FFRoute(
          ...
          path: '/addProductPage',
          asyncParams: {
            'catname': getDoc(['product'], ProductRecord.fromSnapshot),
          },
          builder: (context, params) => AddProductPageWidget(
            catname: params.getParam('catname', ParamType.Document),
          ),
        ),
        FFRoute(
          name: 'vendorProfile',
        ...
        FFRoute(
          ...
          path: '/editprofilevendor',
          builder: (context, params) => EditprofilevendorWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'createProfileCustomer',
          path: '/createProfileCustomer',
          builder: (context, params) => CreateProfileCustomerWidget(),
        ),
        FFRoute(
          name: 'createProfileVendor',
          path: '/createProfileVendor',
          builder: (context, params) => CreateProfileVendorWidget(),
        ),
        FFRoute(
          name: 'orderhistory',
          path: '/orderhistory',
