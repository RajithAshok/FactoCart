...
import 'editprofilevendor_model.dart';
export 'editprofilevendor_model.dart';

class EditprofilevendorWidget extends StatefulWidget {
  const EditprofilevendorWidget({Key? key}) : super(key: key);

  @override
  _EditprofilevendorWidgetState createState() =>
      _EditprofilevendorWidgetState();
}

class _EditprofilevendorWidgetState extends State<EditprofilevendorWidget> {
  late EditprofilevendorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditprofilevendorModel());
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await currentUserReference!.update(createUserRecordData(
                        ...
                        phoneNumber: _model.yourNameController3.text,
                        shipadd: _model.cityController.text,
                      ));
                    },
                    text: 'Save Changes',
