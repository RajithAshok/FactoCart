  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ProductRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final editProductPageProductRecord = snapshot.data!;
                        ...
                        children: [
                            ...
                            children: [
                              InkWell(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.network(
                                    editProductPageProductRecord.image,
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              controller: _model.nameTextFieldController ??=
                                ...
                                text: editProductPageProductRecord.name,
                              ),
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              controller: _model.descTextFieldController ??=
                                  TextEditingController(
                                text: editProductPageProductRecord.desc,
                              ),
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 0.0, 16.0, 0.0),
                            child: TextFormField(
                              controller: _model.stockTextFieldController ??=
                                  TextEditingController(
                                text: editProductPageProductRecord.stock
                                    .toString(),
                              ),
                              focusNode: _model.stockTextFieldFocusNode,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Stock',
                                hintStyle:
                              ...
                              style: FlutterFlowTheme.of(context).bodyMedium,
                              validator: _model
                                  .stockTextFieldControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                            ...
                            child: TextFormField(
                              controller: _model.priceTextFieldController ??=
                                  TextEditingController(
                                text: editProductPageProductRecord.price
                                    .toString(),
                              ),
