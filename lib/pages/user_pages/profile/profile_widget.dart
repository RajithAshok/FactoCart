      ...
      body: SafeArea(
        ...
        child: Container(
          ...
          child: Stack(
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(0.0, 75.0, 0.0, 100.0),
                child: Container(
                  width: double.infinity,
                  height: double.infinity,
                  decoration: BoxDecoration(
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              unawaited(
                                                () async {
                                                  await launchURL(
                                                      'https://instagram.com/factocart?igshid=OGQ5ZDc2ODk2ZA==');
                                                }(),
                                              );
                                            },
                                            child: Icon(
                                              FFIcons.kicons8Instagram,
                                              color:
                                                  FlutterFlowTheme.of(context)
                                                      .secondaryText,
                                              size: 35.0,
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              unawaited(
                                                () async {
                                                  await launchURL(
                                                      'https://twitter.com/factocart');
                                                }(),
                                              );
                                            },
                                            child: Icon(
                                              FFIcons.kicons8Twitterx,
                                              color:
                                                  FlutterFlowTheme.of(context)
                                                      .secondaryText,
                                              size: 35.0,
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              unawaited(
                                                () async {
                                                  await launchURL(
                                                      'https://www.linkedin.com/company/factocart');
                                                }(),
                                              );
                                            },
                                            child: Icon(
